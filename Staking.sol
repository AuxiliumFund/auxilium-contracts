...
contract AuxlStaking is Ownable {
    ...
    /**
        @notice stake Auxl to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve AUXL from warmup
    ...
    /**
        @notice forfeit AUXL in warmup and retrieve Auxl
     */
    ...
    /**
        @notice returns the AUXL index, which tracks rebase growth
        @return uint
     */
    function index() external view returns ( uint ) {
    ...
    /**
        @notice returns contract Auxl holdings, including bonuses provided
        @return uint
     */
    function contractBalance() public view returns ( uint ) {
        return Auxl.balanceOf( address(this) ).add( totalBonus );
    }
